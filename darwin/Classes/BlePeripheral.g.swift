...
protocol BleCallbackProtocol {
  func onReadRequest(characteristicId characteristicIdArg: String, offset offsetArg: Int64, value valueArg: FlutterStandardTypedData?, completion: @escaping (Result<ReadRequestResult?, FlutterError>) -> Void)
  func onWriteRequest(characteristicId characteristicIdArg: String, offset offsetArg: Int64, value valueArg: FlutterStandardTypedData?, completion: @escaping (Result<Void, FlutterError>) -> Void)
  ...
  func onBondStateChange(deviceId deviceIdArg: String, bondState bondStateArg: Int64, completion: @escaping (Result<Void, FlutterError>) -> Void)
...
class BleCallback: BleCallbackProtocol {
  ...
  func onReadRequest(characteristicId characteristicIdArg: String, offset offsetArg: Int64, value valueArg: FlutterStandardTypedData?, completion: @escaping (Result<ReadRequestResult?, FlutterError>) -> Void) {
    ...
    channel.sendMessage([characteristicIdArg, offsetArg, valueArg] as [Any?]) { response in
