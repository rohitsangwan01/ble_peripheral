...
class BlePeripheralChannel {
  ...
  Future<void> updateCharacteristic(String devoiceID, String characteristicId, Uint8List value) async {
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[devoiceID, characteristicId, value]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
...
abstract class BleCallback {
  ...
  ReadRequestResult? onReadRequest(String characteristicId, int offset, Uint8List? value);
  ...
  static void setup(BleCallback? api, {BinaryMessenger? binaryMessenger}) {
    {
      ...
      if (api == null) {
        ...
        __pigeon_channel.setMessageHandler((Object? message) async {
          ...
          final String? arg_characteristicId = (args[0] as String?);
          ...
          try {
            final ReadRequestResult? output = api.onReadRequest(arg_characteristicId!, arg_offset!, arg_value);
    ...
    }
    {
      ...
      if (api == null) {
        ...
        __pigeon_channel.setMessageHandler((Object? message) async {
          ...
          final Uint8List? arg_value = (args[2] as Uint8List?);
          try {
            api.onWriteRequest(arg_characteristicId!, arg_offset!, arg_value);
    ...
    {
      final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.ble_peripheral.BleCallback.onAdvertisingStarted', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        __pigeon_channel.setMessageHandler(null);
      } else {
