...
class BlePeripheralChannel {
  ...
  Future<void> startAdvertising(List<UUID?> arg_services, String arg_localName, int arg_timeoutMillis) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.ble_peripheral.BlePeripheralChannel.startAdvertising', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_services, arg_localName, arg_timeoutMillis]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
